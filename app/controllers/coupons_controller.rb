class CouponsController < ApplicationController
  def index
    ...
    @holiday_1 = NextHolidays.new.holidays_list.holiday_1
    @holiday_2 = NextHolidays.new.holidays_list.holiday_2
    @holiday_3 = NextHolidays.new.holidays_list.holiday_3
  end
